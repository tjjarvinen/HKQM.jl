...
"""
function test_accuracy(n_elements, n_gaussp, n_tpoints; tmax=20, correction=true, alt=false, cmax=10, mode=:normal)
    ...
    if mode == :normal
        @info "Gauss Legendre integration for t"
    ...
    elseif mode == :laguerre
        ...
        T, x, w, t, wt = transformation_tensor_gauss_laguerre(eq, n_gaussp, n_tpoints)
    else
    ...
    @info "Error = $(E-E_true) ; err/E = $(round((E-E_true)/E_true;sigdigits=1))"
    return E-E_true
end
